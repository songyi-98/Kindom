...
public class HelpMeAllListingFragment extends Fragment {
    ...
    private HelpMeAllListingAdapter mAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = getActivity().findViewById(R.id.help_me_all_listing_recycler_view);

        // Create an adapter and supply the data to be displayed.
        mAdapter = new HelpMeAllListingAdapter(getContext(), mHelpMePosts);
