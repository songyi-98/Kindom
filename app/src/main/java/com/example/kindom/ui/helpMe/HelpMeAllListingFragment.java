...
public class HelpMeAllListingFragment extends Fragment {
    ...
    private void show() {
        ...
        if (getContext() != null) {
            ...
            mView.findViewById(R.id.help_me_all_listing_progress_circular).setVisibility(View.GONE);
            ...
            if (mAdapter.getItemCount() == 0) {
                mView.findViewById(R.id.help_me_all_listing_empty).setVisibility(View.VISIBLE);
            }

            Toast.makeText(getContext(), R.string.help_me_all_listing_refresh_toast, Toast.LENGTH_LONG).show();
        }
    }
}